 ...
 */
@Service
public class WorkingHoursCheckObserverImpl implements  WorkingHoursCheckObserver{
	...
	public void update(DailyReport dailyReport)   {
		...
		for(ReimburseDetails reimburseDetails :list){
			...
			osworkflowArgsMap.put("creater","48");
