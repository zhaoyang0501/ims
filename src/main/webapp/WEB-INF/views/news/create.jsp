					...
					<div class="content-widgets">
						...
						<div class="tab-widget">
							<div class="widget-container">
								<form class="form-horizontal" method="post" action="<c:url value='/sysconfig/news/save'></c:url>" onsubmit="return submit_sure();" enctype="multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											<div class="input-append date">
												 <input id="date" name="date" type="text" value="${current }" readonly="readonly">
