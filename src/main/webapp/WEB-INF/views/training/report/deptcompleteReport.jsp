					...
					<div class="span12">
						...
						<div class="content-widgets light-gray">
							...
							<div class="box well form-inline">
								...
								<input id="from_date" type="text" class="span1 date" value="${from_date }">~
								<input id="to_date" type="text" class="span1 date" value="${to_date }">
								<span style="margin-left: 20px;">部门：</span>
								<a style="margin-left: 20px;" onclick="$.ims.trainingreport.initDeptCompleteDataTable()" class="btn btn-info"><i class="icon-zoom-in"></i>查询</a>
							</div>
							<div class="widget-container">
								<table class="responsive table table-striped table-bordered table-condensed"
									id="deptcomplete_dataTable">
									<thead>
										<tr>
											<th rowspan="2" style="width:150px;">部门</th>
											<th colspan="2">计划内数量</th>
											<th colspan="2">计划外数量</th>
											<th colspan="2">合计数量</th>
											<th colspan="2">实际完成数量</th>
											<th rowspan="2">完成率</th>
											<th rowspan="2" style="width:400px;">尚未完成的培训</th>
										</tr>
										<tr>
											<th>内训</th>
											<th>外训</th>
