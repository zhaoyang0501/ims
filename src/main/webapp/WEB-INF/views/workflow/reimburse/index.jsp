				...
				<%@include file="../../breadcrumb.jsp"%>
							...
							<div class="row-fluid">
								<div class="box well form-inline">
									...
									<a class="btn btn-info" type="button" onclick="$.ims.workflowreimburse.initReimburseDataTable()"><i class="icon-search"></i>查询</a>
								</div>
							</div>
							<div class="row-fluid">
								<a class="btn btn-success" style="float: right;margin:5px;" type="button" href="workflow/reimburse/create"><i class="icon-plus"></i>填写报销单</a>
								<table id='reimburseDataTable' class="table-hover responsive table table-striped table-bordered table-condensed">
									<thead>
										<tr>
											<th>报销日期</th>
											<th>报销人员</th>
