							...
							<form id='dayoffform' class="form-horizontal " method="post" action="training/plan/save">
								<table id='' class=" responsive table table-striped table_bordered_black table-condensed formtable" >
									...
									<tr>
										...
										<td  colspan="2"> 
											 <input name='source' type="text"  style='width: 80%' value="${plan.source }" />
										</td>
								...
								<div >
									<button type="submit" class="btn btn-primary" onclick="">发送</button>
									<button type="submit" class="btn btn-primary" onclick="">驳回</button>
