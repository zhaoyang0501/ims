...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/ims/ims.workflow.plan.js"></script>
				...
				<%@include file="../../breadcrumb.jsp"%>
						...
						<div class="row-fluid">
							<div class="box well form-inline">
								...
								<a class="btn btn-info" type="button" onclick="$.ims.workflowplan.inintWorkflowplanDatatable()"><i class="icon-search"></i>查询</a>
							 </div>
						</div>
						 <div class='row-fluid'>
								<a  class="btn btn-success" style="float: right;margin:5px;" type="button" href="${pageContext.request.contextPath}/workflow/plan/create"><i class="icon-plus"></i>新建计划</a>
								<table id="dt_workflowplan" class=" table-hover responsive table table-striped table-bordered table-condensed table-hover ">
									<thead>
										<tr>
