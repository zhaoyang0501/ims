				...
				<%@include file="../../breadcrumb.jsp"%>
						...
						<div class="row-fluid">
							<div class="box well form-inline">
								...
								<a class="btn btn-info" type="button" onclick="$.ims.workflowdayoff.initDayoffDataTable()"><i class="icon-search"></i>查询</a>
							 </div>
						</div>
						 <div class='row-fluid'>
								<a class="btn btn-success" style="float: right;margin:5px;" type="button" href="workflow/dayoff/create"><i class="icon-plus"></i>填写请假单</a>
								<table id='dayoffDataTable' class=" table-hover responsive table table-striped table-bordered table-condensed table-hover ">
									<thead>
										<tr>
											<th>工号</th>
											<th>姓名</th>
