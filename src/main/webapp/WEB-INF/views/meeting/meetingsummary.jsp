...
$(document).ready(function(){	
	...
	$.ims.meeting.reserveSummaryDataTable();
...
<body>
   ...
   <div class="layout">
					...
					<div class="span12">
						<div class="content-widgets " style = "height:100%">
							<div class="widget-head  bondi-blue" >
								...
								<div class="tab-pane active" id="" style = "height:100%">
									<div class="box well form-inline">	
										...
										<div class="input-append date">
											 <input id="s_summaryDate" style="width:80px;" type="text" value="" readonly="readonly">
											 <span class="add-on"><i class="icon-th"></i></span>
										</div>	
										<a  onclick="$.ims.meeting.reserveSummaryDataTable()" class="btn btn-info"><i class="icon-search"></i>查询</a>
									</div> 
										<table class="responsive table table-striped table-bordered table-hover table-condensed" id="reserve_dataTable">
											<thead>
												<tr>
													...
													<th style="width: ">纪要时间</th>
													<th style="width: ">纪要人</th>
													<th style="width:20%">纪要内容</th>
	...
	<!-- 编辑新增弹出框 -->
<div class="modal hide fade" id="summary_edit_modal" style="min-width:870px; ">
							...
							<tr>
								<td> 
									<div class="control-group"> 
										...
										<div class="controls"> 										
											<input type="text" id="roomName" name ="roomName"  readonly="readonly" style="border: 1px solid #C0BBB4; background: #E0E0E0;"> 
										</div> 
									</div> 
								</td>
								<td>
									<div class="control-group"> 
										...
										<div class="controls"> 										
										<input type="text" id="meetingName"  name ="meetingName" maxlength="30"  readonly="readonly"  class="required" style="border: 1px solid #C0BBB4; background: #E0E0E0;"> 
										</div> 
									</div> 
								</td>
							</tr>
		...
		<!-- 										<input type="text" id="attendeeName" style="width: 610px;height: 100%" name="attendeeName"  readonly="readonly"> -->
											<textarea id="attendeeName" style="width: 610px;border: 1px solid #C0BBB4; background: #E0E0E0;"" name ="attendeeName"  disabled="disabled"  class="required" rows="3" ></textarea>
										</div> 
									</div>
								</td>
							</tr>
							...
							<tr>
								<td colspan="2">
									<div class="control-group">
										<label class="control-label"><span class="text-error">* 附件上传：</label></span>
										<div class="controls">
											<input type="file"  class="multi required"  id="multifile" name="multifile[]"  />
										</div>
									</div>
								</td>
							</tr>
